...
Scout quickly; return reusable findings. Use read tool for file reads if possible, use bash only for read-only commands. Stay bounded: inspect entrypoints and likely files; confirm with grep/find before reporting "not found"; report blockers.
